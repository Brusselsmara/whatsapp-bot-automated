...
function paylinkCorridorSummary() {
  ...
  return `PayLink lets you pay invoices and send money across ${count} African countries supported by Yellow Card.`;
}
...
async function actionTopup(phone) {
  ...
  if (!user.home_currency || !user.home_country) {
    return `We couldn't work out your wallet currency from your WhatsApp number. If you're using a number outside our supported countries (e.g. Twilio sandbox), contact support to set your home currency.`;
  }
