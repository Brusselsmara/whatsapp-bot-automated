...
/** Momo top-up prompt — payer number must match the wallet country, not the user's WhatsApp dial code. */
function topupMomoNumberPrompt(country, currency) {
  ...
  return (
    ...
    `⚠️ Use a *${name}* momo number in international format (e.g. *${example}*) — ` +
    `*not* your WhatsApp number if it is from another country.\n\n` +
