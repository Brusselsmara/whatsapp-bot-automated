...
function getDocumentRequirementsMessage(accountType) {
  ...
  return (
    ...
    `We'll notify you in the *PayLink app* when your review is complete.`
  );
}
...
function getMissingDocsNotificationBody(accountType, missingNote) {
  ...
  let body =
    ...
    `Open the PayLink app, tap the bell icon for details, upload the missing items, then reply done in the app.`;
